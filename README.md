...
## 更新履歴: 
- 2026/2/3 v0.2 録画機能の追加
- 2026/2/2 v0.1 クリップ取得ツール試作品公開

## メモ
- コーディングは、ほぼAIを頼りに行っています。Python素人が書いているためコード品質については期待しないでください。
- 1ファイルのexeにビルド済みなので、起動するだけで使えると思います。
- （なぜか）たまに再生など各ボタンが無反応になります。他のUIをクリックすると治ったりします。謎すぎて困ってます。
- 起動時にシークバーの大きさが小さいバグあります。なぜか治らないので放置しています。
